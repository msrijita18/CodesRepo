...
{ 
    ...
    struct row_list* start1 = NULL; 
    struct row_list* start2 = NULL; 
  
    //Function creating List of Lists 
    create_row_list(&start1, R, C, Sparse_Matrix_1); 
    create_row_list(&start2, R, C, Sparse_Matrix_2); 
